...
directory_path = "outputs/wave"
if os.path.exists(directory_path):
    shutil.rmtree(directory_path)
os.makedirs(directory_path)

base_url = "https://hardwax.com/records.json"
section_url = "https://hardwax.com/section/wave.json"
headers = {
...
while True:
    # Fetch the paginated wave section
...
with open(f"{directory_path}/wave_all.json", "w") as f:
